...
MODEL              = pvModel
MODULES            = pvModel_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = pvModel.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/MATLAB Production Server/R2015a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/MATLAB~1/R2015a
MASTER_ANCHOR_DIR  = 
START_DIR          = C:/Users/ironi/Documents/Chinook/Github/PsoMultipleUnits/MATLAB/FastMfc/pv
...
S_FUNCTIONS        = sf_sfun.c sfun_spssw_contc.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
TID01EQ            = 0
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/pvModel \
	-I$(START_DIR) \
