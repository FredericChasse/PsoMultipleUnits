...
clearvars -except rngState dmem pmem jmem
rng(rngState);
...
%   end
  d = d';
  J = J';
  [tt, Y] = ode15s('mfcModelFastParallel', [0 T], mfcDynamics, odeOptions, S0(:, iData), d(:, iData), 0);
  mfcDynamics = Y(end, :);
  [dummy, J(:, iData)] = mfcModelFastParallel(T, mfcDynamics, odeOptions, S0(:, iData), d(:, iData), 1);
  d = d';
  J = J';
  %========================================================================
